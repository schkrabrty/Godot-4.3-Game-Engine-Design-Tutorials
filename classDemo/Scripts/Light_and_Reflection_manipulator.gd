...
@onready var toggle_button2 = $VBoxContainer/HBoxContainer3/RimLightingOnButton
@onready var toggle_button3 = $VBoxContainer/HBoxContainer4/ReflectionButton
...
func _ready() -> void:
	...
	toggle_button2.toggled.connect(Callable(self, "_on_rim_lighting_on"))
	toggle_button3.toggled.connect(Callable(self, "_on_reflection_on"))
	
	## By default this variable will be true so that the cool lighting effects will be visible
	#root_script.lighting_and_reflection_on = true
	## By default this variable will be true so that the reflection effects will be visible
	#root_script.reflection_on = true
...
# This function toggles the rim lighting variable in the root script.
func _on_rim_lighting_on(toggled_on: bool) -> void:
	root_script.rim_lighting_on = toggled_on
	
# This function toggles the rim lighting variable in the root script.
func _on_reflection_on(toggled_on: bool) -> void:
	root_script.reflection_on = toggled_on
